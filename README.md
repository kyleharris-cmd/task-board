...
- In the inline editor: `tab` opens/cycles directory-level path suggestions, `enter` inserts selected suggestion (directories keep drilling down), `esc` or `ctrl+s` saves/closes, `ctrl+q` cancels.
